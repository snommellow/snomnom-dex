            ...
            {pokemon.types.map((type) => {
              ...
              return (
                <span
                  ...
                  style={{ backgroundColor: bg, fontSize: 7, letterSpacing: "0.03em", padding: "3px 4px 3px 4px", width: 58, textShadow: "0 1px 2px rgba(0,0,0,.45)" }}
                >
                  {/* eslint-disable-next-line @next/next/no-img-element */}
...
const FORM_PREFIXES = ["Gigantamax ", "Alolan ", "Galarian ", "Hisuian ", "Paldean ", "Mega ", "Primal ", "Attack Forme ", "Defense Forme ", "Speed Forme ", "Sunny Forme ", "Rainy Forme ", "Snowy Forme ", "Blaze Breed ", "Aqua Breed ", "Sandy Cloak ", "Trash Cloak ", "Origin Forme ", "Sky Forme ", "Heat ", "Wash ", "Frost ", "Fan ", "Mow ", "White Plumage ", "White ", "Black ", "Therian Forme ", "Zen Mode ", "Resolute Forme ", "Pirouette Forme ", "Blue-Striped ", "White-Striped ", "Ash-", "10% Forme ", "Complete Forme ", "Blade Forme ", "Small ", "Large ", "Super ", "Dusk Mane ", "Dawn Wings ", "Ultra ", "Crowned Sword ", "Crowned Shield ", "Eternamax ", "Rapid Strike ", "Single Strike ", "Ice Rider ", "Shadow Rider ", "Bloodmoon ", "Wellspring Mask ", "Hearthflame Mask ", "Cornerstone Mask ", "Teal Mask ", "Female ", "Family of Three ", "Blue Plumage ", "Yellow Plumage ", "Droopy Form ", "Stretchy Form ", "Three-Segment Form ", "Hero Form ", "Roaming Form ", "Low Key Form ", "Amped ", "Low Key ", "Noice Face ", "Hangry Mode ", "Pom-Pom Style ", "Pa'u Style ", "Sensu Style ", "Midnight Form ", "Dusk Form ", "School Form ", "Busted Form ", "Terastal Forme ", "Stellar Forme "] as const;
