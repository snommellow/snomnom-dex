...
// sm4-106 "Kartana-GX": confirmed bordered/non-full-art despite picking as the winning
// candidate — visible card frame bleeding through as a background.
const MISMATCHED_FULL_ART_BLACKLIST = new Set(["swsh9-159", "swsh10-169", "sm10-193", "xy5-153", "sm4-102", "bw5-107", "xy4-122", "xy3-107", "swsh1-53", "swsh10tg-TG16", "swsh10tg-TG19", "swsh10tg-TG20", "sm2-136", "sm1-138", "sm2-141", "sm4-103", "sm4-106"]);
