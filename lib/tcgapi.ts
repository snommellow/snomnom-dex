...
// that also depicts a trainer partner in the art, same category. swsh7-218 "Rayquaza VMAX":
// user-confirmed to share the same Rapid Strike theme/trainer-in-art as its swsh7-194 sibling —
// briefly hardcoded as Rayquaza's background based on price/rarity alone without checking the
// actual art, which was a mistake; blacklisted here so no automated pass re-selects it either.
const MISMATCHED_FULL_ART_BLACKLIST = new Set(["swsh9-159", "swsh10-169", "sm10-193", "xy5-153", "sm4-102", "bw5-107", "xy4-122", "xy3-107", "swsh1-53", "swsh10tg-TG16", "swsh10tg-TG19", "swsh10tg-TG20", "sm2-136", "sm1-138", "sm2-141", "sm4-103", "sm4-106", "swsh5-149", "sm7-159", "swsh7-178", "swsh7-176", "me2-100", "sv10-201", "sm5-145", "sm5-143", "swsh11-172", "swsh7-194", "sv10-192", "swsh7-218"]);
